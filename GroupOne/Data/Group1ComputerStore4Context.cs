...
namespace GroupOne.Data
{
    public partial class Group1ComputerStore4Context : DbContext
    {
        public Group1ComputerStore4Context()
        {
        }

        public Group1ComputerStore4Context(DbContextOptions<Group1ComputerStore4Context> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<OrdersPayment> OrdersPayment { get; set; }
